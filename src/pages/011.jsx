    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="flex flex-col items-center px-4 py-8">
        ...
        <div className="relative w-96 h-96 mb-16">
          ...
          <div className="absolute top-1/2 left-4 transform -translate-y-1/2 w-32 h-32 bg-gray-200 rotate-45 flex items-center justify-center shadow-sm hover:bg-gray-300 transition-colors cursor-pointer group">
            <div className="transform -rotate-45 text-center">
          ...
          <div className="absolute top-1/2 right-4 transform -translate-y-1/2 w-32 h-32 bg-gray-200 rotate-45 flex items-center justify-center shadow-sm hover:bg-gray-300 transition-colors cursor-pointer group">
            <div className="transform -rotate-45 text-center">
              <div className="text-xs font-bold text-black leading-tight">
                SKIN TYPE DETAILS
              </div>
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-32 h-32 bg-gray-200 rotate-45 flex items-center justify-center shadow-sm hover:bg-gray-300 transition-colors cursor-pointer group">
            <div className="transform -rotate-45 text-center">
              <div className="text-sm font-bold text-black">
                WEATHER
              </div>
